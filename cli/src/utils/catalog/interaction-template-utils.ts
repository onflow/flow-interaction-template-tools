      ...
      FLIX_Generators.message({
        ...
        translations: [
          FLIX_Generators.messageTranslation({
            bcp47tag: 'en-US',
            translation: `This transaction initializes a user's account to support ${projectName} NFTs`,
          }),
        ],
      }),
    ],
    ...
    messages: ({ projectName }: { projectName: string }) => [
      FLIX_Generators.message({
        ...
        translations: [
          FLIX_Generators.messageTranslation({
            bcp47tag: 'en-US',
            translation: `This transaction purchases a ${projectName} NFT from a dapp directly`,
          }),
        ],
      }),
    ],
