...
export const signMessage = async (privateKey: string, sigAlg: string, hashAlg: string, msgHex: string) => {
...
export async function sign(privateKey: string, signAlgo: string, hashAlgo: string, msgHex: string): Promise<string> {
