                    ...
                    values?.messageKeys.map((messageKey, messageKeyIndex) => (
                        <Box key={`messageKey-${messageKeyIndex}`}>
                            ...
                            <Button
                                ...
                                type="button"
                                onClick={() => arrayHelpers.insert(messageKeyIndex+1, genMessage(""))}
                            >
                                +
                            </Button>

                            <Box marginLeft="4" marginBottom="4">
                                <FormLabel htmlFor={`messageKeys-${messageKeyIndex}-translations`}>Message Translations</FormLabel>
                                ...
                                <FieldArray
                                    ...
                                    render={arrayHelpersTranslations => 
                                        (values?.messageKeys[messageKeyIndex].translations).map((messageKeyTranslationTag, messageKeyTranslationTagIndex) => (
                                            <Box key={`messageKeys-${messageKeyIndex}-translations-${messageKeyTranslationTagIndex}`}>
                                                <Field 
                                                ...
                                                <Button 
                                                    ...
                                                    type="button"
                                                    onClick={() => arrayHelpersTranslations.remove(messageKeyTranslationTagIndex)} // remove a friend from the list
                                                >
                                                    -
                                                </Button>
                                                <Button
                                                    ...
                                                    type="button"
                                                    onClick={() => arrayHelpersTranslations.insert(messageKeyTranslationTagIndex+1, genMessageTranslation())} // insert an empty string at a position: ;
                                                >
                                                    +
                                                </Button>
                                            </Box>
